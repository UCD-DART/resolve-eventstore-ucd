...
const getLatestEvent = async ({ executeStatement, escapeId, escape, eventsTableName, databaseName, shapeEvent, }, { eventTypes, aggregateIds, startTime, finishTime }) => {
...
exports.default = getLatestEvent;
